...
<img src="assets/app_icon.png" alt="Personal Local AI Workstation Logo" width="120" style="border-radius: 24px; margin-bottom: 12px;" />
...
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-blue?style=for-the-badge&logo=windows)](https://hsini.dev)
[![.NET](https://img.shields.io/badge/.NET-10.0%20WPF%20%26%20WinUI-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)](https://dotnet.microsoft.com)
[![Python](https://img.shields.io/badge/Python-3.10%2B-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://python.org)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.100%2B-009688?style=for-the-badge&logo=fastapi&logoColor=white)](https://fastapi.tiangolo.com)
[![Next.js](https://img.shields.io/badge/Next.js-14.0%20App%20Router-black?style=for-the-badge&logo=next.js&logoColor=white)](https://nextjs.org)
[![Ollama](https://img.shields.io/badge/Ollama-Offline%20LLMs-white?style=for-the-badge&logo=ollama&logoColor=black)](https://ollama.com)
[![License](https://img.shields.io/badge/License-MIT-green?style=for-the-badge)](LICENSE)

<br />

<img src="assets/splash.png" alt="Personal Local AI Workstation Splash Screen Banner" width="100%" style="border-radius: 16px; border: 1px solid #1e293b; margin: 16px 0;" />
...
```mermaid
graph TD
    Client["👤 Client / Engineer"] --> Launcher["⚡ Native .NET 10 Launcher (0.05s)"]
    Launcher --> Splash["🎨 Adobe / DaVinci Style Splash Screen"]
    Splash --> UI["🖥️ Workstation Control Center (Port 3009 / 3000)"]
    
    subgraph Core_Engine["Core Orchestration & Self-Healing Matrix"]
        Router["⚡ FastAPI / Python Core Router (Port 8000 / 3009)"]
        DAG["🐝 Swarm DAG Engine (5-Stage Topological Pipeline)"]
        Healer["🛠️ AST Self-Healing Code Engine"]
    end

    subgraph Memory_Layer["Hybrid Vector & AST Memory Store"]
        AST["🌳 AST Recursive Code Parser"]
        FTS["🔍 SQLite FTS5 BM25 Engine"]
        VEC["🧬 Local SQLite Vector Embeddings"]
        RRF["⚖️ Reciprocal Rank Fusion (RRF)"]
    end

    subgraph Local_Inference_Mesh["Offline Local LLM Mesh (Ollama Port 11434)"]
        QWEN["💻 qwen2.5-coder:7b (Code & Logic)"]
        LLAMA["🧠 llama3:latest (General & Reasoning)"]
        MISTRAL["⚡ mistral:latest (Fast Inference)"]
...
<img src="assets/app_icon.png" width="80" style="border-radius: 16px; margin-bottom: 8px;" />
